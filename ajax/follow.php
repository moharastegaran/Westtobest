...
if (isset($_POST['follow'])) {
    ...
    if (mysqli_num_rows($conn->query("SELECT * FROM friend where user_1='" . $_POST['follow'] . "'and user_2='" . $_SESSION['username'] . "'and acc='0'")) != 0) {
        ...
        $conn->query("UPDATE friend SET acc='1', updated_at=now() where user_1='" . $_POST['follow'] . "' and user_2='" . $_SESSION['username'] . "'");
        ...
        $conn->query("DELETE FROM friend where ( user_1='" . $_SESSION['username'] . "' or user_2='" . $_POST['follow'] . "' ) and ( user_2='" . $_POST['follow'] . "' or user_2='" . $_SESSION['username'] . "' )");
    }
